...
if( !defined( 'SHOUTOUTGLOBAL_WOO_VERSION' ) ) {
	define( 'SHOUTOUTGLOBAL_WOO_VERSION', '3.0.9' );// Plugin Version
}
 ...
 * @since 1.0.0
 */
register_activation_hook( __FILE__, 'shoutout_global_install' );
 ...
 * @since 1.0.0
 */
function shoutout_global_install() {
// added 10/12/18 bu sabweb to remove license key on install. 

if(!get_option('_store_access_key')){	
